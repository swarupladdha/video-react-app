...
public class GetSessionInfoManager {
	...
	private String getDataFromDb(String id) {
		...
		try {
			...
			if (groupzid != 0) {
				MongoCollection<Document> col1 = db
	...
	private String formResponse(String servicetype, String functiontype,
			String response) {
		String res = "";
		try {
			JSONObject j = JSONObject.fromObject(response);
			JSONArray dataArray = j.getJSONObject("json")
			...
			memberDetails.put("_id",
					memInfo.getJSONObject("_id").getString("$oid"));
			...
			morememInfo.put("registeredpersonid",
					memInfo.getInt("registeredpersonid"));
			...
			morememInfo
					.put("divisionlabel", memInfo.getString("divisionlabel"));
			morememInfo.put("subdivisionlabel",
					memInfo.getString("subdivisionlabel"));
			morememInfo.put("leavetypelist",
					memInfo.getJSONArray("leavetypelist"));
			morememInfo.put("managegroupzbase",
					memInfo.getInt("managegroupzbase"));
			...
			morememInfo.put("loginotherusers",
					memInfo.getInt("loginotherusers"));
			morememInfo.put("createissueforothers",
					memInfo.getInt("createissueforothers"));
			morememInfo.put("sendmessages", memInfo.getInt("sendmessages"));
			morememInfo.put("createduetemplate",
					memInfo.getInt("createduetemplate"));
			morememInfo.put("followupissues", memInfo.getInt("followupissues"));
			morememInfo.put("postannouncements",
					memInfo.getInt("postannouncements"));
			morememInfo.put("createalbums", memInfo.getInt("createalbums"));
			morememInfo.put("networkgrouppublisher",
					memInfo.getInt("networkgrouppublisher"));
			...
			morememInfo.put("viewconfidentialinfo",
					memInfo.getInt("viewconfidentialinfo"));
			morememInfo.put("canapprove", memInfo.getInt("canapprove"));
			morememInfo.put("canrecordmessage",
					memInfo.getInt("canrecordmessage"));
			morememInfo.put("enableattendance",
					memInfo.getInt("enableattendance"));

			memberDetails.put("morememinfo", morememInfo);
			memberDetails.put("selection", memInfo.getJSONObject("selection"));

			groupzDetails.put("_id",
					grpInfo.getJSONObject("_id").getString("$oid"));
			groupzDetails.put("groupzbasekey",
					grpInfo.getString("groupzbasekey"));
			...
			// moregroupInfo.put("facebooklink",
			// grpInfo.getString("facebooklink"));
			// }
			// if (grpInfo.containsKey("twitterlink")){
			// moregroupInfo.put("twitterlink",
			// grpInfo.getString("twitterlink"));
			// }
			...
			//
			//
			// moregroupInfo.put("defaultuserrole",
			// grpInfo.getString("defaultuserrole"));
			// moregroupInfo.put("transactionstartdate",
			// grpInfo.getString("transactionstartdate"));
			// moregroupInfo.put("transactionenddate",
			// grpInfo.getString("transactionenddate"));
			// moregroupInfo.put("senderemail",
			// grpInfo.getString("senderemail"));
			// moregroupInfo.put("registrationno",
			// grpInfo.getString("registrationno"));
			...
			// moregroupInfo.put("description",
			// grpInfo.getString("description"));
			...
			// moregroupInfo.put("groupzenabled",
			// grpInfo.getBoolean("groupzenabled"));
			// moregroupInfo.put("metatagdesc",
			// grpInfo.getString("metatagdesc"));
			// moregroupInfo.put("metatagkeywords",
			// grpInfo.getString("metatagkeywords"));
			// moregroupInfo.put("ipaddresses",
			// grpInfo.getString("ipaddresses"));
			// moregroupInfo.put("smscost", grpInfo.getInt("smscost"));
			// moregroupInfo.put("bannerimageurl",
			// grpInfo.getString("bannerimageurl"));
			// moregroupInfo.put("bannerlink:",
			// grpInfo.getString("bannerlink:"));
			// moregroupInfo.put("applicationskin",
			// grpInfo.getString("applicationskin"));
			// moregroupInfo.put("recieptnoprefix",
			// grpInfo.getString("recieptnoprefix"));
			// moregroupInfo.put("userapprovedmailtitle",
			// grpInfo.getString("userapprovedmailtitle"));
			// moregroupInfo.put("userapprovedmailtext",
			// grpInfo.getString("userapprovedmailtext"));
			// moregroupInfo.put("userfailuremailtext",
			// grpInfo.getString("userfailuremailtext"));
			// moregroupInfo.put("userfailuremailtitle",
			// grpInfo.getString("userfailuremailtitle"));
			// moregroupInfo.put("contactmailtitle",
			// grpInfo.getString("contactmailtitle"));
			// moregroupInfo.put("contactmailtext",
			// grpInfo.getString("contactmailtext"));
			// moregroupInfo.put("contactsmstext",
			// grpInfo.getString("contactsmstext"));
			// moregroupInfo.put("greetingmailenabled",
			// grpInfo.getBoolean("greetingmailenabled"));
			// moregroupInfo.put("greetingfamilymembersforemail",
			// grpInfo.getBoolean("greetingfamilymembersforemail"));
			// moregroupInfo.put("greetingsmsenabled",
			// grpInfo.getBoolean("greetingsmsenabled"));
			// moregroupInfo.put("greetingfamilymembersforsms",
			// grpInfo.getBoolean("greetingfamilymembersforsms"));
			// moregroupInfo.put("dueslabel", grpInfo.getString("dueslabel"));
			// moregroupInfo.put("duesenabled", grpInfo.getInt("duesenabled"));
			// moregroupInfo.put("messagelabel",
			// grpInfo.getString("messagelabel"));
			// moregroupInfo.put("smsenabled", grpInfo.getInt("smsenabled"));
			// moregroupInfo.put("emailenabled",
			// grpInfo.getInt("emailenabled"));
			// moregroupInfo.put("albumlabel", grpInfo.getString("albumlabel"));
			// moregroupInfo.put("albumsenabled",
			// grpInfo.getInt("albumsenabled"));
			// moregroupInfo.put("announcementlabel",
			// grpInfo.getString("announcementlabel"));
			// moregroupInfo.put("announcementsenabled",
			// grpInfo.getInt("announcementsenabled"));
			// moregroupInfo.put("advertisementlabel",
			// grpInfo.getString("advertisementlabel"));
			// moregroupInfo.put("advertisementsenabled",
			// grpInfo.getInt("advertisementsenabled"));
			// moregroupInfo.put("surveylabel",
			// grpInfo.getString("surveylabel"));
			// moregroupInfo.put("surveysenabled",
			// grpInfo.getInt("surveysenabled"));
			// moregroupInfo.put("servicerequestlabel",
			// grpInfo.getString("servicerequestlabel"));
			// moregroupInfo.put("issuesenabled",
			// grpInfo.getInt("issuesenabled"));
			// moregroupInfo.put("meeting label",
			// grpInfo.getString("meeting label"));
			// moregroupInfo.put("meetingsenabled",
			// grpInfo.getInt("meetingsenabled"));
			// moregroupInfo.put("noticeslabel",
			// grpInfo.getString("noticeslabel"));
			// moregroupInfo.put("noticesenabled",
			// grpInfo.getString("noticesenabled"));
			// moregroupInfo.put("documentslabel",
			// grpInfo.getString("documentslabel"));
			// moregroupInfo.put("documentssharingenabled",
			// grpInfo.getString("documentssharingenabled"));
			// moregroupInfo.put("plannerlabel",
			// grpInfo.getString("plannerlabel"));
			// moregroupInfo.put("plannerenabled",
			// grpInfo.getInt("plannerenabled"));
			// moregroupInfo.put("banneradsenabled",
			// grpInfo.getInt("banneradsenabled"));
			// moregroupInfo.put("classifiedsearchenabled",
			// grpInfo.getInt("classifiedsearchenabled"));
			// moregroupInfo.put("classifiedsenabled",
			// grpInfo.getInt("classifiedsenabled"));
			// moregroupInfo.put("classifiedsenabled",
			// grpInfo.getInt("classifiedsenabled"));
			// moregroupInfo.put("contactsharingenabled",
			// grpInfo.getInt("contactsharingenabled"));
			// moregroupInfo.put("displayproductlogo",
			// grpInfo.getInt("displayproductlogo"));
			// moregroupInfo.put("familyinformationenabled",
			// grpInfo.getInt("familyinformationenabled"));
			// moregroupInfo.put("helpersenabled",
			// grpInfo.getInt("helpersenabled"));
			// moregroupInfo.put("memberssearchacrosssocietyenabled",
			// grpInfo.getInt("memberssearchacrosssocietyenabled"));
			// moregroupInfo.put("memberssearchenabled",
			// grpInfo.getInt("memberssearchenabled"));
			// moregroupInfo.put("scrollingadsenabled",
			// grpInfo.getInt("scrollingadsenabled"));
			// moregroupInfo.put("issuesettings",
			// grpInfo.getJSONObject("issuesettings"));
			// moregroupInfo.put("webtheme", grpInfo.getJSONObject("webtheme"));
			// moregroupInfo.put("androidtheme",
			// grpInfo.getJSONObject("androidtheme"));
			...
			contentJSON.put("statuscode", Integer.parseInt(PropertiesUtil
