...
/**
 * @author Suthindran G Rao
 * Company : Raos Infosoft Join Pvt. Ltd. 
 */
public class Utils {
    ...
    private static byte[] ENCRYPTION_KEY = new byte[] { 0x11, 0x01, 0x02, 0x03, 0x03, 0x25, 0x06, 0x07, 0x18, 0x19,
            0x0d, 0x0b, 0x0c, 0x0a, 0x4e, 0x0f, 0x56, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x11 };

    public static String getDateTimeAsString(){
        Date date = new Date();
        return "_" + date.getDay() + "_" + date.getMonth() + "_" + (1900 + date.getYear())
    ...
    public static Date getMonthStart(Date date) {
        Date dt = new Date(date.getYear(), date.getMonth(), 1, 0,
                0, 0);
        return dt;
    }
    
    public static Date getMonthEnd(Date date) {
        Date dt = new Date(date.getYear(), date.getMonth(), getMonthDays(date) , 0,
                0, 0);
        return dt;
    }
    ...
    public static String unescapeHtml(String s) {
        String text = s.replaceAll("&lt;", "<").replaceAll("&gt;", ">").replaceAll("&quot;", "\\\"").replaceAll("&#039;",
    ...
    public static String replaceAll(String str, String searchStr,
        ...
        System.out.println( "Replace : " + regExp + " in " + str + " with " + replaceStr  ) ;
        str = str.replaceAll(regExp, replaceStr);
        System.out.println("After replacement : " + str ) ;
        return str;
    }

    public static String replaceCharacterWithSpacesAround(String str, char targetChar,
            char replaceChar) {
