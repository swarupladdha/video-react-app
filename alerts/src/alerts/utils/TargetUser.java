...
public class TargetUser {
		...
		public String personalizeMessage( String mesgBody ) {
			...
			System.out.println( "With " + "Name : " + name + " ContactPersonName : " + contactName + "Number : " + mobileNumber + " Prefix" + prefix + " Email : " + emailId) ;
			if (mesgBody != null && mesgBody.trim().isEmpty() == false) {
				
				replacedMessage = mesgBody ;

				// Ideally a tree should be formed, and the tags should be replaced efficiently as the load increases
					...
					replacedMessage = Utils.replaceAll(replacedMessage, "$ContactPersonPrefix", contactPersonPrefix+contactName) ;
			}
