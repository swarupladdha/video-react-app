...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    {		
			try{    
				...
				service.put("servicetype", resource.getString("paymentGateway_success_serviceType"));
				service.put("functiontype", resource.getString("successful_payment_functionType"));
				jsonObj.put("request", reqObj);
				mainObj.put("json", jsonObj);
				URL url=new URL(resource.getString("successurl")+mainObj);
	...
	if(status.trim().equalsIgnoreCase("success")) {
		...
		String redirectURL = resource.getString("successWebUrl");
